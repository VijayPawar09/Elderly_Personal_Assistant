...
const CustomerDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (!currentToken) {
      ...
      alert(
        "This page is only accessible to customers. Please login as a customer."
      );
  ...
  useEffect(() => {
    // Load assistants immediately so Available Assistants shows all entries
    fetchAssistants();
  }, []);
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-1 mt-1">
                            ...
                            <span className="text-sm text-gray-600">
                              {assistant.rating || 0} (
                              {assistant.reviewCount || 0} reviews)
                            </span>
                          </div>
                        </div>
                      </div>
              ...
              {!assistantsLoading && assistants.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">
                    No assistants available at the moment
                  </p>
                </div>
              )}
            </div>
                    ...
                    <div className="mt-2 space-y-2">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-600">
                          ...
                          {selectedAppointment.hours} hours)
                        </span>
                      </div>
                      <div className="flex items-center">
