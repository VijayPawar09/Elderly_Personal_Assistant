  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <aside
        ...
        } transition-all duration-300 bg-blue-800 text-white`}
      >
...
function ResidentsTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      {error && (
        <div className="p-3 text-red-800 bg-red-100 rounded-md">{error}</div>
      )}
...
function StaffTab() {
  ...
  useEffect(() => {
    // Fetch assistants when the staff tab mounts so the list is available immediately
    fetchAssistants();
  }, []);
  ...
  return (
    <div className="space-y-6">
      ...
      {activeStaffTab === "requests" && <AssistantRegistrationHandler />}
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      ...
      <p className="mt-2 text-gray-600">
        Manage activities, medication schedules, and appointments
      </p>
    </div>
  );
}
...
function AppointmentsTab() {
  ...
  const handleAssign = async (appointmentId, assistantId) => {
    try {
      ...
      const response = await appointmentAPI.assignAssistant(
        appointmentId,
        assistantId
      );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">
            Assign assistants to customer appointments
          </p>
        </div>
        <button
          onClick={fetchData}
                    ...
                    <td className="p-4">
                      <div className="space-y-2">
                        <select
                          ...
                          onChange={(e) =>
                            handleAssign(apt._id, e.target.value)
                          }
...
function MessagesTab() {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      ...
      <p className="mt-2 text-gray-600">
        Send notifications to staff and family members
      </p>
    </div>
  );
}
...
function ReportsTab() {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center">
      ...
      <p className="mt-2 text-gray-600">
        Generate insights and reports on resident care
      </p>
    </div>
  );
}
